...
import xyz.yazhe.yazheweb.constants.ResourceConstants;
...
import xyz.yazhe.yazheweb.module.user.auth.POJO.DO.UserRole;
import xyz.yazhe.yazheweb.module.user.auth.POJO.DTO.UserDTO;
import xyz.yazhe.yazheweb.module.user.auth.POJO.DTO.UserRegisterDTO;
import xyz.yazhe.yazheweb.module.user.auth.dao.UserAuthMapper;
import xyz.yazhe.yazheweb.module.user.auth.dao.UserMapper;
import xyz.yazhe.yazheweb.module.user.auth.dao.UserRoleMapper;
import xyz.yazhe.yazheweb.module.user.auth.service.UserService;
